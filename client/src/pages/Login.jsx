...
export default function Login() {
  ...
  return (
    <div className="container" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '80vh' }}>
      ...
      <div style={{ position: 'fixed', top: '20%', left: '30%', width: '300px', height: '300px', background: 'rgba(59, 130, 246, 0.15)', filter: 'blur(100px)', borderRadius: '50%', zIndex: 0, pointerEvents: 'none' }} />
      <div style={{ position: 'fixed', bottom: '20%', right: '30%', width: '300px', height: '300px', background: 'rgba(99, 102, 241, 0.1)', filter: 'blur(100px)', borderRadius: '50%', zIndex: 0, pointerEvents: 'none' }} />
      ...
      <div style={{ 
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h2 style={{ fontSize: '1.75rem', fontWeight: '800', margin: 0, color: 'white' }}>Bienvenido de nuevo</h2>
          <p style={{ color: 'var(--text-muted)', marginTop: '8px', fontSize: '0.95rem' }}>Ingresa tus credenciales para continuar</p>
        </div>
        ...
        <div style={{ marginTop: '2rem', textAlign: 'center', fontSize: '0.9rem', color: 'var(--text-muted)' }}>
          ¿No tienes una cuenta? <Link to="/register" style={{ color: '#60a5fa', fontWeight: '600', textDecoration: 'none', marginLeft: '4px' }}>Regístrate aquí</Link>
        </div>
      </div>
    </div>
  );
